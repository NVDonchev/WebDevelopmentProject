...
<?php htmlRender::beginForm(array("action"=>"changeQuantityOfProduct", "method"=>"POST")); ?>
<table class="table">
    <tr>
        <th>Name</th>
        <th>Price</th>
...
<br>
<input type="submit" value="Select Product to Change Quantity" class="btn btn-success"><br>
